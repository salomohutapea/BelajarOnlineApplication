...
import kotlinx.android.synthetic.main.activity_video_bio1.*

class VideoBio1 : YouTubeBaseActivity() {

    //Data untuk API youtube
    companion object {
        val VIDEO_ID: String = "YzmrHNL-Sis" //ID video youtube
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_video_bio1)
