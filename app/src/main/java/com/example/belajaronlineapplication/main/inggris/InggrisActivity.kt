package com.example.belajaronlineapplication.main.inggris
...
import com.example.belajaronlineapplication.main.inggris.Lesson1Inggris.LatihanSoalInggris1
import com.example.belajaronlineapplication.main.inggris.Lesson1Inggris.VideoInggris1
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.activity_biology.*

class InggrisActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        llLatihanTopik.setOnClickListener {
            val latihanSoalIntent = Intent(
                this@InggrisActivity,
                LatihanSoalInggris1::class.java
            )
            startActivity(latihanSoalIntent)
            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out)
        }
        //Jika linear layout topik1 diclick, maka akan menampilkan VideoInggris1, yang berisi video youtube
        llTopik1.setOnClickListener {
            val videoIntent = Intent(
                this@InggrisActivity,
                VideoInggris1::class.java
            )
