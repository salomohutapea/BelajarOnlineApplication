package com.example.belajaronlineapplication.main.fisika
...
import com.example.belajaronlineapplication.main.fisika.Lesson1Fis.LatihanSoalFis1
import com.example.belajaronlineapplication.main.fisika.Lesson1Fis.VideoFis1
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.activity_fisika.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        llLatihanTopik.setOnClickListener {
            val latihanSoalIntent = Intent(
                this@FisikaActivity,
                LatihanSoalFis1::class.java
            )
            startActivity(latihanSoalIntent)
            overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out)
        }
        //Jika linear layout topik1 diclick, maka akan menampilkan VideoFis1, yang berisi video youtube
        llTopik1.setOnClickListener {
            val videoIntent = Intent(
                this@FisikaActivity,
                VideoFis1::class.java
            )
